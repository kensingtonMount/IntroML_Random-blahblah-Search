...
toc
disp('Pause for result checking. Press a key to continue.')
pause;
...
ga_opts = optimoptions(@ga, ...
                     'PlotFcn',{@gaplotdistance,@gaplotgenealogy,@gaplotselection,@gaplotscores,@gaplotstopping,@gaplotbestf});
[x_ga_opt,  fval, exitFlag,output] = ga(h, Nw, ga_opts); 
